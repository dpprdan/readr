...
#> [[1]]
#> [1] "/tmp/Rtmptzibi6/file1d1641576656"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x563658c70bb0>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/Rtmptzibi6/file1d16386b2c85"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/Rtmptzibi6/file1d167474dacc"
#> 
#> $skip
#> [1] 0
#> 
