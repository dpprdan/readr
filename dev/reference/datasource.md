...
#> [[1]]
#> [1] "/tmp/Rtmp8YxXHe/file1ea72c5d6dea"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x55ad9dce7820>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/Rtmp8YxXHe/file1ea776de626f"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/Rtmp8YxXHe/file1ea746b731a6"
#> 
#> $skip
#> [1] 0
#> 
