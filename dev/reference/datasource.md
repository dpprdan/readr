...
#> [[1]]
#> [1] "/tmp/RtmpZuJZhF/file18b47f6a53cc"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x55deef0d7f50>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/RtmpZuJZhF/file18b45d5fa9fd"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/RtmpZuJZhF/file18b47847f80b"
#> 
#> $skip
#> [1] 0
#> 
