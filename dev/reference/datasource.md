...
#> [[1]]
#> [1] "/tmp/RtmppL9afV/file1c7f566fa44f"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x5615ea78e510>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/RtmppL9afV/file1c7f308920e9"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/RtmppL9afV/file1c7f1d9d3ae8"
#> 
#> $skip
#> [1] 0
#> 
